...
import BossEditorForm from "@/features/bosses/admin/bossEditorForm";
import DropDragSidePanel from "@/components/admin/common/dropSidePanel";
	...
	return (
		<div className='flex flex-col gap-3 max-w-[280px] p-1'>
			...
			{!powers || powers.length === 0 ? (
				...
				<div className='flex flex-col gap-2.5 max-h-64 overflow-y-auto pr-1-scrollbar'>
