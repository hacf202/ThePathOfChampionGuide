...
import RatingModal from "@/features/champions/components/RatingModal";
import CommunityRatingsList from "@/features/champions/components/CommunityRatingsList";
			...
			{showInfo && createPortal(
				<div className='fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm animate-fadeIn'>
					...
					<div className='bg-surface-bg border border-border rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col relative z-10 overflow-hidden animate-slideUp'>
						...
						{/* Modal Body */}
						<div className='p-5 md:p-6 overflow-y-auto-scrollbar bg-surface-bg grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6'>
