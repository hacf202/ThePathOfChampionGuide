...
function ChampionCard({ champion }) {
	...
	return (
		<HoverCard>
			...
			<div className='group relative w-full aspect-[340/500] bg-gray-800 rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 hover:shadow-2xl'>
